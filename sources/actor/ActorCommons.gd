...
static var DefaultInventory : Dictionary = {
	...
	"3" : { "id": "Scimitar".hash(), "count": 1, "customfield": "" },
	"4" : { "id": "Bone Knife".hash(), "count": 1, "customfield": "" },
	"5" : { "id": "Cleaver".hash(), "count": 1, "customfield": "" },
	"6" : { "id": "Gladius".hash(), "count": 1, "customfield": "" },
	"7" : { "id": "Piou Slayer".hash(), "count": 1, "customfield": "" },
	"8" : { "id": "Rock Knife".hash(), "count": 1, "customfield": "" },
	"9" : { "id": "Short Sword".hash(), "count": 1, "customfield": "" },
	"10" : { "id": "Raw Wood Shield".hash(), "count": 1, "customfield": "" },
	"11" : { "id": "Leather Shield".hash(), "count": 1, "customfield": "" },
	"12" : { "id": "Bandana Scarf".hash(), "count": 1, "customfield": "" },
	"13" : { "id": "Leather Pants".hash(), "count": 1, "customfield": "" },
	"14" : { "id": "Cloud Pants".hash(), "count": 1, "customfield": "" },
	"15" : { "id": "Funky Hat".hash(), "count": 1, "customfield": "" },
	"16" : { "id": "Desert Hood".hash(), "count": 1, "customfield": "" },
	"17" : { "id": "Leather Gloves".hash(), "count": 1, "customfield": "" },
	"18" : { "id": "Leather Armbands".hash(), "count": 1, "customfield": "" },
	"19" : { "id": "Leather Boots".hash(), "count": 1, "customfield": "" },
	"20" : { "id": "Desert Boots".hash(), "count": 1, "customfield": "" },
	"21" : { "id": "Tank Top".hash(), "count": 1, "customfield": "" },
	"22" : { "id": "Crop Top".hash(), "count": 1, "customfield": "" },
	"23" : { "id": "Leather Shirt".hash(), "count": 1, "customfield": "" },
	"24" : { "id": "Cotton Shirt".hash(), "count": 1, "customfield": "" },
	"25" : { "id": "Letter".hash(), "count": 1, "customfield": "" },
	"26" : { "id": "Jean Chaps".hash(), "count": 1, "customfield": "" },
	"27" : { "id": "Shorts".hash(), "count": 1, "customfield": "Cerulean" },
}
