...
const PaletteHairPst : String			= CellPst + "palettes/hair/"
const PaletteEquipPst : String			= CellPst + "palettes/equipment/"
const PaletteSkinPst : String			= CellPst + "palettes/skin/"
