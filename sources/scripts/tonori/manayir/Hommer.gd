...
func DisplayChoices():
	...
	Choice("What are the Uru?", OnUru)
	Choice("Farewell.", Farewell)

func OnAboutManayir():
	Mes("We are Makutu. An order of druids gathered to research, teach and protect the order of Mana in our world.")
	Mes("Long ago we were spread across the region, each of us tending to Uru that grew nearby. That time is behind us now.")
...
func OnUru():
	Mes("The Uru, or Mana Trees as they are also known, were the pillars of Mana in our world.")
	...
	Mes("When people came to fear Mana, they cut them down. It spread fast. The Aukati gave it a doctrine and a purpose, and before long there were none left.")
